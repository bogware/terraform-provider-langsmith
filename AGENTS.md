...
- **Org chart acceptance tests**: `langsmith_org_chart*` tests also require `LANGSMITH_ORGANIZATION_ID` (or `organization_id` on the provider); they skip when it is unset.
